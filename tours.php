				...
				<div class="row">
					<div id="container">
						...
						<div class="row">
							...
							<?php if ($result->error == "OK") : ?>

								<?php $pages = ceil($result->total_tour_count / $per_page); ?>
								<p>Page <strong>
								<?php print $page; ?>
								</strong> of <strong>
								<?php print $pages; ?>
												...
												<div class="card-body">
													...
													<div class="right price-panel">
														...
														<p class="tourcms-card-text price"><span class='fromprice'>from
																<?php print $tour->from_price_display; ?></span></p>
													</div>
									...
									<div class="col-12 col-md-6 col-lg-4 col-xl-3">
										<div class="card tour-mobile">
											...
											<div class="card-footer bg-transparent">
												...
												<p class="tourcms-card-text tour-mobile-footer-right" style=""><a href="https://wordpress.tourcms.com/tours/day-tour-example-1-departure-a-day-inline-booking/">Book
														now <span class='fromprice'>from <?php print $tour->from_price_display; ?> </span></a><br></p>
											</div>
										</div>
									</div>
